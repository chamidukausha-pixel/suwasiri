...
- [x] Unique Health ID Sync to Portal is clinic-scoped (PrimeCare vs other hospitals); Chamidu `SW3C6F5B5A27` / Sakuni `SW6CF9340271`; hashed dummy barcode patients are purged and never generated. Lookup/save uses the person’s real Suwasiri name (health profile / clinic registration), never the Auth placeholder “Patient”.
