...
**Receipts & Invoices** and **Clinical Audit Trail** use the same month calendar. Click a date (and a practitioner, or All Practitioners / All Categories) to show that day’s activity: consultations, edits, medicines, prescriptions, lab reports, reviews, medical certificates, and doctor notes. Audit rows cannot be deleted. Unpaid / not-settled invoice rows are highlighted (amber, overdue red) and listed first. Reception **Cash Settle** marks the row **Settled**. If the patient paid in the Suwasiri app, status is **Paid by Suwasiri App**. Click a PDF or image slip to open it. Age and gender show under the name on Lobby, Patient Clinical Records, Unique Health ID sync, and invoices.
