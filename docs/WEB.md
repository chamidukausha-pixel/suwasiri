...
8. **Lobby queue** — receptionist **Check In Now** still lives on Reception Schedule. The Doctor Dashboard no longer shows Lobby Active Queue, Clinical Alerts, Pathology/Recalls/Documents tiles, or Check In.
