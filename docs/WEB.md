...
**Practice Manager → Locations** is Branch CRUD. **Staff & Practitioners** can **add a doctor** (name, email, specialty, photo) and **remove** them — they appear or disappear on this list and in the Suwasiri app the same way as Platform Console. Weekly roster assigns working **days and hours** (e.g. Dr. Silva Mon/Wed/Fri 16:00–18:00); save and edit later. The purple **Auto-Select Mon–Fri** control is removed; the blue **Auto-Select All (Mon–Sun)** control remains.
...
**Receipts & Invoices** and **Clinical Audit Trail** use the same month calendar. Click a date (and a practitioner, or All Practitioners / All Categories) to show that day’s activity: consultations, edits, medicines, prescriptions, lab reports, reviews, medical certificates, and doctor notes. Audit rows cannot be deleted. Unpaid / not-settled invoice rows are highlighted (amber, overdue red) and listed first. Reception **Cash Settle** marks the row **Settled** and updates Reports collected. Suwasiri **debit/card** is collected immediately (**Paid by Suwasiri App**). A **bank slip** uploaded in the Suwasiri app stays **Slip awaiting approval** until reception clicks **Approved** under Invoice actions; then Reports collected updates. Anyone not settled or not yet approved shows as **pending payment** in Reports. Click a PDF or image slip to open it. Age and gender show under the name on Lobby, Patient Clinical Records, Unique Health ID sync, and invoices.
