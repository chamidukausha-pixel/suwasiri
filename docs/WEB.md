...
**Practice Manager → MBS & Private Fees:** Super Admin / Practice Manager can edit item codes and private fees, **Add MBS Item**, map an item to a Suwasiri booking reason (medical certificate / repeat prescription / review results), **delete** items, and save. That private fee is the only amount shown in the Suwasiri app for those reasons (not the standard consultation fee). The bulk-billable column is removed.
