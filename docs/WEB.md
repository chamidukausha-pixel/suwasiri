...
**Practice Manager → MBS & Private Fees:** Super Admin / Practice Manager can edit item codes and private fees, **Add MBS Item**, map an item to a Suwasiri Home booking (medical certificate / repeat prescription / review results), **delete** items, and save. On the Suwasiri **Home** icons those private fees are the only amount shown at checkout (defaults LKR 1000 / 1500 / 1200 until Firestore syncs). A normal **Book appointment** still uses the doctor’s consultation fee. The bulk-billable column is removed.
