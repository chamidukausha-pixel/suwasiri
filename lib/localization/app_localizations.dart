...
class AppLocalizations {
  ...
  static const _map = <String, Map<String, String>>{
    ...
    'notifFilterAll': {'en': 'All', 'si': 'සියල්ල', 'ta': 'அனைத்தும்'},
    'notifFilterMessages': {
      'en': 'Messages',
      'si': 'පණිවිඩ',
      'ta': 'செய்திகள்',
    },
    'notifFilterApps': {'en': 'Apps', 'si': 'යෙදුම්', 'ta': 'செயலிகள்'},
    'notifReply': {'en': 'Reply', 'si': 'පිළිතුරු', 'ta': 'பதில்'},
    'notifSnooze': {'en': 'Snooze', 'si': 'පසුවට', 'ta': 'பின் தள்ளி'},
    'notifDismiss': {'en': 'Dismiss', 'si': 'ඉවත් කරන්න', 'ta': 'நீக்கு'},
    'notifDone': {'en': 'Done', 'si': 'අවසන්', 'ta': 'முடிந்தது'},
    'notifNow': {'en': 'now', 'si': 'දැන්', 'ta': 'இப்போது'},
    'rateHowWasConsult': {
      'en': 'How was your consultation?',
      'si': 'ඔබේ උපදේශනය කෙසේද?',
      'ta': 'உங்கள் ஆலோசனை எப்படி இருந்தது?',
    },
    'rateConsultCompletedAt': {
      'en': 'Consultation completed at {time}',
      'si': 'උපදේශනය අවසන් වූයේ {time}',
      'ta': 'ஆலோசனை முடிந்த நேரம் {time}',
    },
    'rateSubmit': {
      'en': 'Submit Rating',
      'si': 'ඇගයීම යවන්න',
      'ta': 'மதிப்பீட்டை அனுப்பு',
    },
    'rateMaybeLater': {
      'en': 'Maybe later',
      'si': 'පසුව සිතමි',
    ...
    'rateThanks': {
      'en': 'Thank you for rating your doctor',
      'si': 'වෛද්‍යවරයා ඇගයීමට ස්තූතියි',
      'ta': 'மருத்துவரை மதிப்பிட்டதற்கு நன்றி',
    },
    'ratePickStars': {
      'en': 'Tap a star',
      'si': 'තරුවක් තට්ටු කරන්න',
      'ta': 'ஒரு நட்சத்திரத்தைத் தட்டவும்',
    },
    'rateLabel1': {'en': 'Poor', 'si': 'දුර්වලයි', 'ta': 'மோசம்'},
    'rateLabel2': {'en': 'Fair', 'si': 'සාමාන්‍යයි', 'ta': 'சாதாரணம்'},
    'rateLabel3': {'en': 'Okay', 'si': 'හොඳයි', 'ta': 'சரி'},
    'rateLabel4': {'en': 'Good', 'si': 'ඉතා හොඳයි', 'ta': 'நன்று'},
    'rateLabel5': {'en': 'Excellent', 'si': 'විශිෂ්ටයි', 'ta': 'சிறப்பு'},
    'rateTagAttentive': {
      'en': 'Attentive',
      'si': 'අවධානයෙන්',
      'ta': 'கவனமுள்ளவர்',
    },
    'rateTagKnowledgeable': {
      'en': 'Knowledgeable',
      'si': 'දැනුමැති',
      'ta': 'அறிவுள்ளவர்',
    },
    ...
    'rateTagExplained': {
      'en': 'Clearly explained',
      'si': 'පැහැදිලිව තේරුම් දුන්නා',
      'ta': 'தெளிவாக விளக்கினார்',
    },
    'rateTagKind': {'en': 'Kind', 'si': 'කරුණාවන්ත', 'ta': 'அன்பானவர்'},
    'liveSynced': {
      'en': 'Live Synced',
      'si': 'සජීවී සමමුහුර්ත',
      'ta': 'நேரடி ஒத்திசைவு',
